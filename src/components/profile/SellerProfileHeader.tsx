        ...
        <CardContent className="p-8">
          ...
          <div className="flex flex-col lg:flex-row items-start gap-8 relative z-10">
            ...
            <div className="flex-1 space-y-6">
              ...
              {/* Service Categories */}
              {profileStats?.serviceCategories && profileStats.serviceCategories.length > 0 && (
                <div className="space-y-3">
                  <div className="flex items-center gap-3">
                    <div className="p-2 rounded-lg bg-primary/10">
                      <Target className="w-5 h-5 text-primary" />
                    </div>
                    <span className="font-semibold text-foreground">Service Categories</span>
                  </div>
                  <div className="flex flex-wrap gap-3">
                    {profileStats.serviceCategories.map((category, index) => (
                      <Badge 
                        key={index} 
                        variant="outline" 
