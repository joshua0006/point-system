...
const LeadGenCampaigns = () => {
  ...
  const fetchUserCampaigns = async () => {
    ...
    try {
      const {
        data,
        error
      } = await supabase.from('campaign_participants').select(`
          *,
          lead_gen_campaigns (
            id,
            name,
  ...
  return <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 pb-12">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-8">
            <div className="flex justify-between items-center mb-6">
              ...
              <div className="flex items-center gap-4">
                {isAdmin && <Button variant={adminMode ? "default" : "secondary"} size="sm" onClick={() => {
            ...
            <div className="max-w-4xl mx-auto">
              <h1 className="text-4xl md:text-5xl font-bold text-foreground mb-4">Lead Gen Campaigns</h1>
          ...
          {!adminMode && userCampaigns.length > 0 && <div className="mb-12">
              ...
              return <Card key={participation.id} className={`transition-all duration-300 ${isActive ? 'hover:shadow-lg border-border hover:border-primary/30' : 'border-warning/40 bg-muted/50 opacity-60'}`}>
                        <CardContent className="p-6">
                          ...
                          <div className="space-y-4">
                            ...
                            <div className="flex items-center justify-between">
                              ...
                              {roi !== '0' && <Badge variant="outline" className={`${parseFloat(roi) > 0 ? 'text-green-600 border-green-200' : 'text-red-600 border-red-200'}`}>
                            ...
                            {/* Status Message */}
                            {participation.billing_status === 'stopped' && <div className="p-3 bg-warning/10 border border-warning/30 rounded-lg">
          ...
          <div className="max-w-6xl mx-auto">
            ...
            {adminMode ? <AdminInterface campaignTargets={campaignTargets} setCampaignTargets={setCampaignTargets} editingTarget={editingTarget} setEditingTarget={setEditingTarget} showTargetDialog={showTargetDialog} setShowTargetDialog={setShowTargetDialog} refreshTargets={refreshTargets} /> : <>
                {/* Campaign Flow */}
      ...
      {successCampaignDetails && <CampaignLaunchSuccessModal isOpen={showSuccessModal} onClose={() => {
