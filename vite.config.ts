      ...
      output: {
        ...
        manualChunks: (id) => {
          ...
          if (id.includes('node_modules')) {
            ...
            // LESSON LEARNED: Cannot split ANY React libraries due to module loading race conditions
            // Even libraries that only use React at runtime (React Query, React Hook Form)
            // import React during module initialization, causing race conditions
            ...
            if (
              ...
              // CRITICAL: State management - uses React hooks (imports React at module level)
              id.includes('@tanstack/react-query') || id.includes('zustand') ||
              // CRITICAL: Form libraries - react-hook-form uses useLayoutEffect (imports React)
              ...
              return 'vendor-react'; // Keep ALL React libraries together - splitting causes race conditions
            }
